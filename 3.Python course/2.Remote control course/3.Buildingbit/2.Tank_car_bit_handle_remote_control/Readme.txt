...
¢ÙYou should download the Tank_car_program.py to the micro:bit board of the Tank car.
...
After the program is downloaded, the handle and the car are powered up normally, they will be automatically paired, you can start to control car by handle within valid range.