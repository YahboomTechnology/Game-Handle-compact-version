...
¢ÙYou should download the Following_car_code.py to the micro:bit board of the Following car.
...
After the program is downloaded, the handle and the car are powered up normally, they will be automatically paired, you can start to control Following car by handle within valid range.