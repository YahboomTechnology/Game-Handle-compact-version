...
¢ÙYou should download the Hexapod_robot_program.py to the micro:bit board of the Hexapod robot.
...
After the program is downloaded, the handle and the car are powered up normally, they will be automatically paired, you can start to control robot by handle within valid range.