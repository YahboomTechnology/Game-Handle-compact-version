...
¢ÙYou should download the Mechanical_Clip_code.py to the micro:bit board of the Mechanical Clip.
...
After the program is downloaded, the handle and the car are powered up normally, they will be automatically paired, you can start to control Mechanical Clip by handle within valid range.