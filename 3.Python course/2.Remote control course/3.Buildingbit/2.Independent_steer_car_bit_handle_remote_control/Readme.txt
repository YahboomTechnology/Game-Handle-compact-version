...
¢ÙYou should download the Independent_steer_car_code.py to the micro:bit board of the Independent steer car.
¢ÚYou should download the bit_handle_code.py to the micro:bit board of the handle.
...
After the program is downloaded, the handle and the car are powered up normally, they will be automatically paired, you can start to control Independent steer car by handle within valid range.