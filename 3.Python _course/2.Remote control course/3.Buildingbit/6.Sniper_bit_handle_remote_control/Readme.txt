...
¢ÙYou should download the Sniper_code.py to the micro:bit board of the Sniper.
...
After the program is downloaded, the handle and the car are powered up normally, they will be automatically paired, you can start to control Sniper by handle within valid range.