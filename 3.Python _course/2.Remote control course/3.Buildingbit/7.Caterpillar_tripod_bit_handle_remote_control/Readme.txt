...
¢ÙYou should download the Caterpillar_tripod_code.py to the micro:bit board of the Caterpillar tripod.
...
After the program is downloaded, the handle and the car are powered up normally, they will be automatically paired, you can start to control Caterpillar tripod by handle within valid range.